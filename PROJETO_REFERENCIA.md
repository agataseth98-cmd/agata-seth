...
**Reversão parcial, 27/08/2026 (MEMÓRIAS (283), seção "Memória em duas camadas" do PROJETO.md):** o "fica inteiro de fora" acima passa a valer só para os assuntos pessoais e as partes do ACB desnecessárias ao sistema. Assunto do próprio sistema pode voltar ao escopo com autorização explícita do Humano e o mesmo controle de proposta/verificação/registro.
