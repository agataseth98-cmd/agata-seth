...
- Rode quando puder, os 4 que faltam: `bash scripts/aprovar.sh whisper-restringe-path-2026-09-21` · `bash scripts/aprovar.sh bounded-request-concorrencia-2026-09-21` · `bash scripts/aprovar.sh discord-allowlist-canal-2026-09-21` · `bash scripts/aprovar.sh perimetro-2a-passada-2026-09-21`
...
- Rode quando puder: `bash scripts/aprovar.sh bounded-request-concorrencia-2026-09-21`
...
- Rode quando puder: `bash scripts/aprovar.sh discord-allowlist-canal-2026-09-21`
- Detalhe técnico completo: `MEMÓRIAS.md`, entrada (505).
...
- Rode quando puder: `bash scripts/aprovar.sh perimetro-2a-passada-2026-09-21`
