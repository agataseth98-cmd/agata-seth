...
| B2 | **Rotação por família** (`propostas/dossie-rotacao-por-familia.md`, 07/09) | Dossiê pronto, com perguntas abertas. | Decisão sua. A de maior peso: **a Seth entra na rotação?** (hoje papel fixo por (140) — botar pra rotacionar revoga essa decisão). Outras perguntas no §"perguntas" do dossiê. |
