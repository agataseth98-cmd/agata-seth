#!/usr/bin/env bash
# Regenera ~/agata/.hermes.md a partir de REGRAS.md + PROJETO.md + fim do MEMÓRIAS.md.
...

{
  ...
  echo "Gerado por .githooks/gerar-hermes-md.sh a partir de REGRAS.md + PROJETO.md + fim do MEMÓRIAS.md."
  ...
  cat PROJETO.md
  echo ""
  echo "# MEMÓRIAS.md (últimas $DIARIO_LINHAS linhas)"
  echo ""
  tail -n "$DIARIO_LINHAS" MEMÓRIAS.md
} > "$OUT"
